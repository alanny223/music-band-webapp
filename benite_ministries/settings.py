"""
Django settings for benite_ministries project.
...
ROOT_URLCONF = 'benite_ministries.urls'
...
WSGI_APPLICATION = 'benite_ministries.wsgi.application'
...
# Maximum size for in-memory file uploads (e.g., 100 MB)
